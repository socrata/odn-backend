...
app.get('/data/v1/chart/line/:variable', require('./app/controllers/data/v1/chart/line/controller'));
//app.get('/data/v1/chart/table/:variable', require('./app/controllers/data/v1/chart/table/controller'));
